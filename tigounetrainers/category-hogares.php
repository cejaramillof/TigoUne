...
<div class="container">
    <div class="row">
        ...
        $cats = get_categories(array( 'child_of' => 10 )); 
            ...
            foreach ($cats as $cat) {
                ...
                if (have_posts()) : while (have_posts()) : the_post(); ?>
                    ...
                    <div class="col s6 m3 l3 item_sub">
                        <img class="hvr-float" src="https://www.tigounetrainers.com/wp-content/themes/tigounetrainers/img/news/monitor.png" width="80px">

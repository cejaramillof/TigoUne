(function ($) {
    ...
    function renderMultiData(a) {
        ...
        if (username == null) {
          var stackedVal = '<div class="control-form-item-multidata-staked-value"><span data-name="' + name + '">' + value + '</span><b> - No hay información. </b><i class="control-form-item-multidata-delete-data ttr-icon-close-round"></i></div>';
        } else {
          var stackedVal = '<div class="control-form-item-multidata-staked-value"><span data-name="' + name + '">' + value + '</span><b> - ' + username.nombre_empleado + ' / ' + username.cargo + ' / ' + username.canal + ' / ' + username.regional + '</b><i class="control-form-item-multidata-delete-data ttr-icon-close-round"></i></div>';          
        }

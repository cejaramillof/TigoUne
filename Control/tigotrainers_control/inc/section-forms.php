...
<div class="control-section-container">
    <ul class="control-form-list">
        ...
        if (current_user_can('administrator') || in_array($user_data->id, $test)){ ?>
            <li class="control-open-form" data-form="for_vas_33_hogares_diego">Inducción Hogares</li>
            <li class="control-open-form" data-form="for_vas_33_movil_diego">Inducción Movil</li>
            <li class="control-open-form" data-form="for_vas_33_tiendas_servicio_diego">Inducción Tiendas</li>
            ...
            -->
            <li class="control-open-form" data-form="for_vas_34_union">Entrenamiento Móvil - Hogares</li>
            <li class="control-open-form" data-form="for_vas_34_empresas">Entrenamiento B2B</li>
            <!--<li class="control-open-form" data-form="for_vas_34_asistencia">Asistencia B2B Business Digital Day</li>-->
        <?php }
        ...
        elseif (isset($user_data->business_unit)){
	        ...
	        switch ($user_data->business_unit) {
	            ...
	            case 'EDATEL': ?>
	                ...
	                <li style="padding:0!important;"><a style="display: block; padding: 11px 13px;" href="https://control.tigotrainers.com/marcacion/acompanamiento-premisas">Acompañamiento</a></li>
                    <li style="padding:0!important;"><a style="display: block; padding: 11px 13px;" href="https://control.tigotrainers.com/marcacion/acompanamiento-premisas">Acompañamiento Supervisores</a></li>

...
if ( ! isset( $_POST['form'], $_POST['init-date'], $_POST['end-date'] ) ) {
	die( 'Error, en descarga. Intentalo de nuevo!' );
}
...
switch ( $form ) {
	...
	case 'for_vas_34_3':
		...
		break;
	case 'for_vas_34_4':
		query_forvas_34_4( $init, $end, $form );
		break;
	case 'for_vas_35':
...
function query_forvas_33_2( $i, $e, $formName ) {
	...
	$sql = "SELECT * FROM trnrs_forvas33_3 WHERE fecha_actividad BETWEEN '$i' AND '$e'";
...
function query_forvas_34_4( $i, $e, $formName ) {
	global $wpdb;

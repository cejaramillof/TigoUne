	...
	$.fn.formBuilder = function(options) {
		...
		*/
		var bindSettings = function() {	
			...
			// Choices
			if(currentlySelected.data('type') == 'element-radio' || currentlySelected.data('type') == 'element-checkboxes' || currentlySelected.data('type') == 'element-dropdown') {
		...
		var rules = function() {
			...
			$("#control-add-rule").click(function(){
				...
				$('.form-element').each(function(){
					...
					if( type == 'element-radio' ) { fields.push( { label: label } ); }
		...
		var controlMultipleChoice = function() {
			...
			$('.add-choice').click(function(){
				...
				dust.render(currentlySelected.children('.choices').data('type'), data, function(err, out) {
					...
					if( currentlySelected.data('type') == 'element-radio' ) {
		...
		*/
		var serialize = function() {
			...
			$('#sortable-elements li').each(function(i){
				...
				if( element['type'] == 'element-radio' || element['type'] == 'element-checkboxes' ||  element['type'] == 'element-dropdown' ) {
				...
				$('.loading').fadeOut(function(){
					...
					$('#save').click(function(e){
						...
						$.ajax({
							...
							success: function ( data ) {
								settings.onSaveForm.call( null, data );
							}
